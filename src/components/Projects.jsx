...
import blackPinkTick from "../assets/icons/blackPinkTick.svg";
  ...
  return (
    <>
      <section className="projectsSection">
        ...
        <p>
          A snap shot of the apps I've built. Along my journey I've picked up
          skills and increased my knowledge of Javascript and its libraries.
        ...
        Inside a project card goes a title, image card (containing an image) and text, and some text */}
          <div className="projectCards">
            ...
            <div className="projectDiscription">
              <p className="projectDiscriptionTitle">Project discription</p>
              <div>
                <svg
                  className="blueTick"
                  width="40px"
                  height="40px"
                  viewBox="0 0 170.00 170.00"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  stroke="#5bb5f1"
                  stroke-width="2.7199999999999998"
                >
              ...
              <p>
                ...
                How does it work? By utilising juicy data from the police.uk api
              </p>
              <p>
                <svg
                  className="blueTick"
                ...
                How was it made? Using Javascript - React - CSS - HTML
              </p>
              <p>
                <svg
                  className="blueTick"
                ...
                Challenges: navigating the police.uk api and its docs, (come
                back to this){" "}
              </p>
              <p>
                {""}
